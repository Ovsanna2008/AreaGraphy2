...
public class QuizActivityHistory2 extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = "QuizActivityHistory2";
    ...
    List<QuestionAnswerHistory2> questions = new ArrayList<>();
    private DatabaseReference database;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_history2);
    ...
    private void fetchQuizQuestions() {
        database.child("quizQuestions2").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    QuestionAnswerHistory2 question = snapshot.getValue(QuestionAnswerHistory2.class);
    ...
    void checkAnswer() {
        ...
        QuestionAnswerHistory2 currentQuestion = questions.get(currentQuestionIndex);
    ...
    void loadNewQuestion() {
        if (currentQuestionIndex < questions.size()) {
            QuestionAnswerHistory2 question = questions.get(currentQuestionIndex);
