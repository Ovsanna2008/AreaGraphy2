...
public class QuizActivitySurface1 extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = "QuizActivitySurface1";
    ...
    List<QuestionAnswerSurface1> questions = new ArrayList<>();
    private DatabaseReference database;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_surface1);
    ...
    private void fetchQuizQuestions() {
        database.child("quizQuestions5").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    QuestionAnswerSurface1 question = snapshot.getValue(QuestionAnswerSurface1.class);
    ...
    void checkAnswer() {
        ...
        QuestionAnswerSurface1 currentQuestion = questions.get(currentQuestionIndex);
    ...
    void loadNewQuestion() {
        if (currentQuestionIndex < questions.size()) {
            QuestionAnswerSurface1 question = questions.get(currentQuestionIndex);
