...
public class QuizActivityHistory3 extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = "QuizActivityHistory3";
    ...
    List<QuestionAnswerHistory3> questions = new ArrayList<>();
    private DatabaseReference database;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_history3);
        ...
        questionTextView = findViewById(R.id.question); // Initialize questionTextView here
    ...
    private void fetchQuizQuestions() {
        database.child("quizQuestions3").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    QuestionAnswerHistory3 question = snapshot.getValue(QuestionAnswerHistory3.class);
    ...
    void checkAnswer() {
        ...
        QuestionAnswerHistory3 currentQuestion = questions.get(currentQuestionIndex);
    ...
    void loadNewQuestion() {
        if (currentQuestionIndex < questions.size()) {
            QuestionAnswerHistory3 question = questions.get(currentQuestionIndex);
