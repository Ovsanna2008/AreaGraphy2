...
public class QuizActivitySurface4 extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = "QuizActivitySurface4";
    ...
    List<QuestionAnswerSurface4> questions = new ArrayList<>();
    private DatabaseReference database;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_surface4);
    ...
    private void fetchQuizQuestions() {
        database.child("quizQuestions8").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    QuestionAnswerSurface4 question = snapshot.getValue(QuestionAnswerSurface4.class);
    ...
    void checkAnswer() {
        ...
        QuestionAnswerSurface4 currentQuestion = questions.get(currentQuestionIndex);
    ...
    void loadNewQuestion() {
        if (currentQuestionIndex < questions.size()) {
            QuestionAnswerSurface4 question = questions.get(currentQuestionIndex);
