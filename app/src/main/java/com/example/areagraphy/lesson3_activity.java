...
public class lesson3_activity extends AppCompatActivity {
    ...
    private void getTextFromFirebase() {
        mDatabase.child("lesson1").child("history2").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    public void QuizActivityHistory3(View view) {
        startActivity(new Intent(this, QuizActivityHistory3.class));
    }
}
