...
public class QuizActivityCrust4 extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = "QuizActivityCrust4";
    ...
    List<QuestionAnswerCrust4> questions = new ArrayList<>();
    private DatabaseReference database;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_crust4);
    ...
    private void fetchQuizQuestions() {
        database.child("quizQuestions12").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    QuestionAnswerCrust4 question = snapshot.getValue(QuestionAnswerCrust4.class);
    ...
    void checkAnswer() {
        ...
        QuestionAnswerCrust4 currentQuestion = questions.get(currentQuestionIndex);
    ...
    void loadNewQuestion() {
        if (currentQuestionIndex < questions.size()) {
            QuestionAnswerCrust4 question = questions.get(currentQuestionIndex);
