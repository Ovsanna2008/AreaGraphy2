...
public class QuizActivityCrust1 extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = "QuizActivityCrust1";
    ...
    List<QuestionAnswerCrust1> questions = new ArrayList<>();
    private DatabaseReference database;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_crust1);
    ...
    private void fetchQuizQuestions() {
        database.child("quizQuestions9").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    QuestionAnswerCrust1 question = snapshot.getValue(QuestionAnswerCrust1.class);
    ...
    void checkAnswer() {
        ...
        QuestionAnswerCrust1 currentQuestion = questions.get(currentQuestionIndex);
    ...
    void loadNewQuestion() {
        if (currentQuestionIndex < questions.size()) {
            QuestionAnswerCrust1 question = questions.get(currentQuestionIndex);
