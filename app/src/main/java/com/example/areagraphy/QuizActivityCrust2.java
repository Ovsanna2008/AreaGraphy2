...
public class QuizActivityCrust2 extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = "QuizActivityCrust2";
    ...
    List<QuestionAnswerCrust2> questions = new ArrayList<>();
    private DatabaseReference database;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_crust2);
    ...
    private void fetchQuizQuestions() {
        database.child("quizQuestions10").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    QuestionAnswerCrust2 question = snapshot.getValue(QuestionAnswerCrust2.class);
    ...
    void checkAnswer() {
        ...
        QuestionAnswerCrust2 currentQuestion = questions.get(currentQuestionIndex);
    ...
    void loadNewQuestion() {
        if (currentQuestionIndex < questions.size()) {
            QuestionAnswerCrust2 question = questions.get(currentQuestionIndex);
