...
public class QuizActivityCrust3 extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = "QuizActivityCrust3";
    ...
    List<QuestionAnswerCrust3> questions = new ArrayList<>();
    private DatabaseReference database;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_crust3);
    ...
    private void fetchQuizQuestions() {
        database.child("quizQuestions11").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    QuestionAnswerCrust3 question = snapshot.getValue(QuestionAnswerCrust3.class);
    ...
    void checkAnswer() {
        ...
        QuestionAnswerCrust3 currentQuestion = questions.get(currentQuestionIndex);
    ...
    void loadNewQuestion() {
        if (currentQuestionIndex < questions.size()) {
            QuestionAnswerCrust3 question = questions.get(currentQuestionIndex);
