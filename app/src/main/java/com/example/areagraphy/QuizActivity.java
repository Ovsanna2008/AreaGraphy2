...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void fetchQuizQuestions() {
        database.child("quizQuestions1").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    QuestionAnswer question = snapshot.getValue(QuestionAnswer.class);
    ...
    void checkAnswer() {
        ...
        QuestionAnswer currentQuestion = questions.get(currentQuestionIndex);
    ...
    void loadNewQuestion() {
        if (currentQuestionIndex < questions.size()) {
            QuestionAnswer question = questions.get(currentQuestionIndex);
