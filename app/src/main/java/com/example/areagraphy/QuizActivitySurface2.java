...
public class QuizActivitySurface2 extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = "QuizActivitySurface2";
    ...
    List<QuestionAnswerSurface2> questions = new ArrayList<>();
    private DatabaseReference database;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_surface2);
    ...
    private void fetchQuizQuestions() {
        database.child("quizQuestions6").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    QuestionAnswerSurface2 question = snapshot.getValue(QuestionAnswerSurface2.class);
    ...
    void checkAnswer() {
        ...
        QuestionAnswerSurface2 currentQuestion = questions.get(currentQuestionIndex);
    ...
    void loadNewQuestion() {
        if (currentQuestionIndex < questions.size()) {
            QuestionAnswerSurface2 question = questions.get(currentQuestionIndex);
