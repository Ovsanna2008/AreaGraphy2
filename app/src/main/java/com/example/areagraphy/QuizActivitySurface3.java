...
public class QuizActivitySurface3 extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = "QuizActivitySurface3";
    ...
    List<QuestionAnswerSurface3> questions = new ArrayList<>();
    private DatabaseReference database;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_surface3);
    ...
    private void fetchQuizQuestions() {
        database.child("quizQuestions7").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    QuestionAnswerSurface3 question = snapshot.getValue(QuestionAnswerSurface3.class);
    ...
    void checkAnswer() {
        ...
        QuestionAnswerSurface3 currentQuestion = questions.get(currentQuestionIndex);
    ...
    void loadNewQuestion() {
        if (currentQuestionIndex < questions.size()) {
            QuestionAnswerSurface3 question = questions.get(currentQuestionIndex);
